...
InsertRecord('taxgroups', array('taxgroupid', 'taxgroupdescription'), array('1','Default tax group'), array('taxgroupid', 'taxgroupdescription'), array('1','Default tax group'), $db);
