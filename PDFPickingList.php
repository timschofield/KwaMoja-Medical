...
if ((!isset($_GET['TransNo']) or $_GET['TransNo'] == '') and !isset($_POST['TransDate'])) {
	...
	echo '<table class="selection">
		<tr>
			...
			<td><input type="text" class="date" alt="' . $_SESSION['DefaultDateFormat'] . '" name="TransDate" minlength="1" maxlength="10" size="11" value="' . date($_SESSION['DefaultDateFormat'], mktime(date('m'), date('Y'), date('d') + 1)) . '" /></td>
		</tr>';
	echo '<tr><td>' . _('From Warehouse') . ' : ' . '</td>
			<td><select minlength="1" name="loccode">';
