...
if (!(isset($_POST['Search']))) {
	...
	echo '<tr>
			...
			<td><input class="number" tabindex="4" type="text" name="MaxDaysOfStock" size="8"	minlength="0" maxlength="8" value="999" /></td>
			<td>' . ' ' . _('Days of Stock (QOH + QOO) Available') . ' </td>
		 </tr>';
	//view number of NumberOfTopItems items
	echo '<tr>
			<td>' . _('Number Of Top Items') . ' </td><td>:</td>
			<td><input class="number" tabindex="4" type="text" name="NumberOfTopItems" size="8"	minlength="0" maxlength="8" value="100" /></td>
		 </tr>
		 <tr>
			<td></td>
			<td></td>
	...
	echo '<form onSubmit="return VerifyForm(this);" onSubmit="return VerifyForm(this);" action="PDFTopItems.php"  method="GET">';
    echo '<div>';
    echo '<input type="hidden" name="FormID" value="' . $_SESSION['FormID'] . '" />';
	echo '<table class="selection">';
	$TableHeader = '<tr>
