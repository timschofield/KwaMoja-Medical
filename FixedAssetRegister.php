...
if (isset($_POST['submit']) or isset($_POST['pdf']) or isset($_POST['csv'])) {
	...
	if (isset($_POST['pdf'])) {
		...
		echo '<form onSubmit="return VerifyForm(this);" onSubmit="return VerifyForm(this);" id="RegisterForm" method="post" class="noPrint" action="' . htmlspecialchars($_SERVER['PHP_SELF'],ENT_QUOTES,'UTF-8') . '">
              <div>';
