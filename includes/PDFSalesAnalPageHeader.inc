...
$PDF->line($Left_Edge, $Bottom_Edge, $Right_Edge, $Bottom_Edge);
/*Draw the bottom line */
$PDF->line($Right_Edge, $Bottom_Edge, $Right_Edge, $Top_Edge);
/*Draw the right side line */
$PDF->line($Right_Edge, $Top_Edge, $Left_Edge, $Top_Edge);
/*Draw the top line */
$PDF->line($Left_Edge, $Bottom_Edge, $Left_Edge, $Top_Edge);
...
while ($Cols = DB_fetch_array($ColsResult)) {
	...
	$LeftOvers = $PDF->addTextWrap($Xpos, $Ypos - $line_height, 60, $FontSize, $Cols['heading2'], 'centre');
}
