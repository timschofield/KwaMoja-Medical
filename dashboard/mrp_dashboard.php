...
<table border="0" cellspacing="0" cellpadding="0" style="max-width:100%;width:99%;">
	...
	$searchresult = DB_query($SQL, $db);
		...
		echo " <td width='85px'><a href=" . $RootPath . "/StockStatus.php?StockID=" . $StockID . " target='_blank'>  " . $row['stockid'] . " </td>";
						echo " <td width='85px'> " . $row['description'] . " </td><td width='85px'>$qoh</td><td> " . $row['units'] . " </td></tbody> ";
