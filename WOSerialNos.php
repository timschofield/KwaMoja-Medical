...
if ($Serialised == 1 and $NextSerialNo > 0) {
	...
	echo ':</td>
		<td><input type="text" name="NumberToAdd" size="10" class="number" minlength="1" maxlength="10" value="1" /></td>
	...
	if ($Serialised == 0) { //also need to add the quantity
		echo '<td><input type="text" name="Quantity" size="10" class="number" minlength="1" maxlength="10" value="1" /></td>';
