	...
	echo '<tfoot>
			<tr>
				<td class="text" colspan="6">', // Prints an explanation of signs in absolute and relative variations:
					'<br /><b>', _('Notes'), ':</b><br />', _('Absolute variation signs: a positive number indicates a source of funds; a negative number indicates an application of funds.'), '<br />', _('Relative variation signs: a positive number indicates an increase in the amount of that account; a negative number indicates a decrease in the amount of that account.'), '<br />
				</td>
			</tr>
		</tfoot>
