...
$YPos -= 15;
$FontSize = 12;
$LeftOvers2 = $PDF->addTextWrap($Left_Margin, $YPos, 550, $FontSize, _('Shipped') . ' ' . ConvertSQLDateTime($TransferRow['shipdate']));

$YPos -= 15;
$FontSize = 12;
$LeftOvers2 = $PDF->addTextWrap($Left_Margin, $YPos, 550, $FontSize, _('From') . ' ' . $TransferRow['shiplocname']);
