...
class SuppTrans {
	...
	var $GRNs;
	/*array of objects of class GRNs using the GRN No as the pointer */
	var $GLCodes;
	/*array of objects of class GLCode using a counter as the pointer */
	var $Shipts;
	/*array of objects of class Shipment using a counter as the pointer */
	var $Contracts;
	/*array of objects of class Contract using a counter as the pointer */
	var $Assets;
	/*array of objects of class Asset using a counter as the pointer */
	var $SupplierID;
	var $SupplierName;
	var $CurrCode;
	...
	function Add_Asset_To_Trans($AssetID, $Amount) {
		if ($Amount != 0) {
			$this->Assets[$this->AssetCounter] = new Asset($this->AssetCounter, $AssetID, $Amount);
			$this->AssetCounter++;
			return 1;
		}
		return 0;
	...
	function Add_Contract_To_Trans($ContractRef, $Amount, $Narrative, $AnticipatedCost) {
		if ($Amount != 0) {
			$this->Contracts[$this->ContractsCounter] = new Contract($this->ContractsCounter, $ContractRef, $Amount, $Narrative, $AnticipatedCost);
