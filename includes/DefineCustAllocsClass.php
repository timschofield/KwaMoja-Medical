...
class Allocn {
	...
	var $ID;
	/* DebtorTrans ID of the transaction alloc to */
	var $TransType;
	var $TypeNo;
	var $TransDate;
	var $AllocAmt;
	...
	var $PrevAlloc;
	/*Total of allocations vs this trans from other receipts/credits*/
	var $OrigAlloc;
	/*Allocation vs this trans from the same receipt/credit before modifications */
	var $PrevAllocRecordID;
	/*The CustAllocn record ID for the previously allocated amount
