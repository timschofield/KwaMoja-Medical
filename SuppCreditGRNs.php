...
echo '<input type="text" name="Show_Since" minlength="1" maxlength="11" size="12" class="date" alt="' . $_SESSION['DefaultDateFormat'] . '" value="' . $_POST['Show_Since'] . '" />
...
if (DB_num_rows($GRNResults) > 0) {
	...
	if (isset($_POST['GRNNo']) and $_POST['GRNNo'] != '') {
		...
		echo '<tr>
				...
				<td><input type="text" name="This_QuantityCredited" value="' . locale_number_format($myrow['qtyostdg'], $myrow['decimalplaces']) . '" size="11" minlength="1" maxlength="10" /></td>
				<td class="number">' . locale_number_format($Price, $_SESSION['SuppTrans']->CurrDecimalPlaces) . '</td>
				<td><input type="text" name="ChgPrice" value="' . locale_number_format($Price, $_SESSION['SuppTrans']->CurrDecimalPlaces) . '" size="11" minlength="1" maxlength="10" /></td>
			</tr>
			</table>';
