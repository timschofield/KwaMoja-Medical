...
if (!isset($_GET['delete'])) {
	...
	*/
	...
	echo '<td><input tabindex="4" type="text" name="BrAddress1" size="41" minlength="0" maxlength="40" value="'. $_POST['BrAddress1'].'" /></td>
		</tr>
		<tr>
	...
	echo '<td><input tabindex="5" type="text" name="BrAddress2" size="41" minlength="0" maxlength="40" value="'. $_POST['BrAddress2'].'" /></td>
		</tr>
		<tr>
	...
	echo '<td><input tabindex="6" type="text" name="BrAddress3" size="41" minlength="0" maxlength="40" value="'. $_POST['BrAddress3'].'" /></td>
		</tr>
		<tr>
	...
	echo '<td><input tabindex="7" type="text" name="BrAddress4" size="31" minlength="0" maxlength="30" value="'. $_POST['BrAddress4'].'" /></td>
		</tr>
		<tr>
	...
	echo '<td><input tabindex="8" type="text" name="BrAddress5" size="21" minlength="0" maxlength="20" value="'. $_POST['BrAddress5'].'" /></td>
		</tr>
		<tr>
			<td>'._('Country').':</td>';
	...
	echo '<td><input tabindex="23" type="text" name="BrPostAddr1" size="41" minlength="0" maxlength="40" value="'. $_POST['BrPostAddr1'].'" /></td>
		</tr>
		<tr>
	...
	echo '<td><input tabindex="24" type="text" name="BrPostAddr2" size="41" minlength="0" maxlength="40" value="'. $_POST['BrPostAddr2'].'" /></td>
		</tr>
		<tr>
	...
	echo '<td><input tabindex="25" type="text" name="BrPostAddr3" size="31" minlength="0" maxlength="30" value="'. $_POST['BrPostAddr3'].'" /></td>
		</tr>
		<tr>
	...
	echo '<td><input tabindex="26" type="text" name="BrPostAddr4" size="21" minlength="0" maxlength="20" value="'. $_POST['BrPostAddr4'].'" /></td>
		</tr>
		<tr>
	...
	echo '<td><input tabindex="27" type="text" name="CustBranchCode" size="31" minlength="0" maxlength="30" value="'. $_POST['CustBranchCode'].'" /></td>
		</tr>
		</table>
		<br />
		<div class="centre">
