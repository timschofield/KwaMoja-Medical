...
echo '<tr>
		<th colspan="3"><font color="navy" size="4">' . _('Financial report for the radiology department on') . ':</font>
		<input type="text" class="date" alt="' . $_SESSION['DefaultDateFormat'] . '" onchange="ReloadForm(submit)" name="ReportDate" maxlength="10" size="11" value="' . $_POST['ReportDate'] . '" /><input type="submit" name="submit" value="Refresh" /></th>
	</tr>';
