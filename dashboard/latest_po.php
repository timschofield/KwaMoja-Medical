...
<table style="max-width:100%;width:99%;" cellspacing="0" cellpadding="0" border="0">
      <tr>
		...
		$SQL = 'SELECT purchorders.orderno,
					...
					GROUP BY purchorders.orderno,
						...
						echo '<tbody><tr><th> Supplier </th><th>Order Date</th><th>Delivery Date</th><th>Order Total</th><th>Status</th></tr></tbody> ';
						$k=0;
			...
			$k = 1;
						...
						echo ' <td>'.$FormatedOrderDate1.'</td><td>'.$FormatedDelDate1.'</td><td>'.$FormatedOrderValue2.'</td><td> ' . $row['status'] . ' </td> ';
