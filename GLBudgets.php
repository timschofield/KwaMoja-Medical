...
if (isset($SelectedAccount) and $SelectedAccount != '') {
	...
	for ($i = 1; $i <= 12; $i++) {
		...
		echo '<td><input type="text" class="number" minlength="1" maxlength="12" size="12" name="' . $i . 'this" value="' . locale_number_format($Budget[$CurrentYearEndPeriod - (12 - $i)], $_SESSION['CompanyRecord']['decimalplaces']) . '" /></td>';
		...
		echo '<td><input type="text" class="number" minlength="1" maxlength="12" size="12" name="' . $i . 'next" value="' . locale_number_format($Budget[$CurrentYearEndPeriod + $i], $_SESSION['CompanyRecord']['decimalplaces']) . '" /></td>';
		echo '</tr>';
