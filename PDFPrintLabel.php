...
if ((isset($_POST['ShowLabels']) or isset($_POST['SetAll'])) and isset($_POST['FromCriteria']) and mb_strlen($_POST['FromCriteria']) >= 1 and isset($_POST['ToCriteria']) and mb_strlen($_POST['ToCriteria']) >= 1) {
	...
	while ($LabelRow = DB_fetch_array($LabelsResult)) {
		...
		echo '<tr>
				...
				<td><input type="text" required="required" maxlength="4" name="Qty' . $i . '" size="4" class="number" value="' . locale_number_format($_POST['Qty' . $i], 0) . '" /></td>
			</tr>';
...
if (isset($_POST['PrintLabels']) and $NoOfLabels > 0) {
	...
	if (!isset($_POST['FromCriteria']) or !isset($_POST['ToCriteria'])) {
		...
		echo '<tr>
				...
				<td><select autofocus="autofocus" required="required" name="LabelID">';
		...
		echo '<tr>
				...
				<td><input type="text" required="required" maxlength="10" size="11" class="date" alt="' . $_SESSION['DefaultDateFormat'] . '" name="EffectiveDate" value="' . Date($_SESSION['DefaultDateFormat']) . '" /></td>
			</tr>';
