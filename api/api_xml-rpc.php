...
$Description = _('This function is used to login into the API methods for the specified the database.') . '<p>' . _('NOTE: using this function means that the User Name and Password fields in the following functions are no longer required.  When calling those functions, leave the last two parameters off.') . '</p>';
...
$Parameter[1]['description'] = _('A valid kwamoja username. This user should have security access to this data.');
$Parameter[2]['name'] = _('User password');
$Parameter[2]['description'] = _('The kwamoja password associated with this user name. ');
$ReturnValue[0] = _('This function returns an integer. ') . _('Zero means the function was successful. ') . _('Otherwise an error code is returned. ');
...
function xmlrpc_Login($xmlrpcmsg) {
	...
	$rtn = new xmlrpcresp(php_xmlrpc_encode(LoginAPI($xmlrpcmsg->getParam(0)->scalarval(), $xmlrpcmsg->getParam(1)->scalarval(), $xmlrpcmsg->getParam(2)->scalarval())));
	ob_end_flush();
	return $rtn;
}
...
$Description = _('This function is used to logout from the API methods. ') . _('It terminates the user\'s session thus freeing the server resources.');
$ReturnValue[0] = _('This function returns an integer. ') . _('Zero means the function was successful. ') . _('Otherwise an error code is returned. ');
$Logout_sig = array(
	array(
		$xmlrpcStruct
...
$Description = _('This function is used to insert a new customer into the KwaMoja database.');
$Parameter[0]['name'] = _('Customer Details');
$Parameter[0]['description'] = _('A set of key/value pairs where the key must be identical to the name of the field to be updated. ') . _('The field names can be found ') . '<a href="../../Z_DescribeTable.php?table=debtorsmaster">' . _('here ') . '</a>' . _('and are case sensitive. ') . _('The values should be of the correct type, and the api will check them before updating the database. ') . _('It is not necessary to include all the fields in this parameter, the database default value will be used if the field is not given.') . '<p>' . _('If the Create Debtor Codes Automatically flag is set, then anything sent in the debtorno field will be ignored, and the debtorno field will be set automatically.');
$Parameter[1]['name'] = _('User name');
$Parameter[1]['description'] = _('A valid kwamoja username. This user should have security access  to this data.');
$Parameter[2]['name'] = _('User password');
$Parameter[2]['description'] = _('The kwamoja password associated with this user name. ');
$ReturnValue[0] = _('This function returns an array of integers. ') . _('If the first element is zero then the function was successful. ') . _('Otherwise an array of error codes is returned and no insertion takes place. ');
...
function xmlrpc_InsertCustomer($xmlrpcmsg) {
	ob_start('ob_file_callback');
	/*x*/
	if ($xmlrpcmsg->getNumParams() == 3) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(InsertCustomer(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
...
$Description = _('This function is used to insert a new customer branch into the KwaMoja database.');
$Parameter[0]['name'] = _('Branch Details');
$Parameter[0]['description'] = _('A set of key/value pairs where the key must be identical to the name of the field to be updated. ') . _('The field names can be found ') . '<a href="../../Z_DescribeTable.php?table=custbranch">' . _('here ') . '</a>' . _('and are case sensitive. ') . _('The values should be of the correct type, and the api will check them before updating the database. ') . _('It is not necessary to include all the fields in this parameter, the database default value will be used if the field is not given.');
$Parameter[1]['name'] = _('User name');
$Parameter[1]['description'] = _('A valid kwamoja username. This user should have security access  to this data.');
$Parameter[2]['name'] = _('User password');
$Parameter[2]['description'] = _('The kwamoja password associated with this user name. ');
...
function xmlrpc_InsertBranch($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(InsertBranch(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(InsertBranch(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
$Description = _('This function is used to modify a customer which is already setup in the KwaMoja database.');
$Parameter[0]['name'] = _('Customer Details');
$Parameter[0]['description'] = _('A set of key/value pairs where the key must be identical to the name of the field to be updated. ') . _('The field names can be found ') . '<a href="../../Z_DescribeTable.php?table=debtorsmaster">' . _('here ') . '</a>' . _('and are case sensitive. ') . _('The values should be of the correct type, and the api will check them before updating the database. ') . _('It is not necessary to include all the fields in this parameter, the database default value will be used if the field is not given.') . '<p>' . _('The debtorno must already exist in the kwamoja database.');
$Parameter[1]['name'] = _('User name');
$Parameter[1]['description'] = _('A valid kwamoja username. This user should have security access  to this data.');
$Parameter[2]['name'] = _('User password');
$Parameter[2]['description'] = _('The kwamoja password associated with this user name. ');
$ReturnValue[0] = _('This function returns an array of integers. ') . _('If the first element is zero then the function was successful. ') . _('Otherwise an array of error codes is returned and no modification takes place. ');
...
function xmlrpc_ModifyCustomer($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(ModifyCustomer(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(ModifyCustomer(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
$Description = _('This function is used to modify a customer branch which is already setup in the KwaMoja database.');
$Parameter[0]['name'] = _('Branch Details');
$Parameter[0]['description'] = _('A set of key/value pairs where the key must be identical to the name of the field to be updated. ') . _('The field names can be found ') . '<a href="../../Z_DescribeTable.php?table=custbranch">' . _('here ') . '</a>' . _('and are case sensitive. ') . _('The values should be of the correct type, and the api will check them before updating the database. ') . _('It is not necessary to include all the fields in this parameter, the database default value will be used if the field is not given.') . '<p>' . _('The branchcode/debtorno combination must already exist in the kwamoja database.');
$Parameter[1]['name'] = _('User name');
$Parameter[1]['description'] = _('A valid kwamoja username. This user should have security access  to this data.');
$Parameter[2]['name'] = _('User password');
$Parameter[2]['description'] = _('The kwamoja password associated with this user name. ');
...
function xmlrpc_ModifyBranch($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(ModifyBranch(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(ModifyBranch(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
$Parameter[0]['description'] = _('This is a string value. It must be a valid debtor number that is already in the KwaMoja database.');
$Parameter[1]['name'] = _('User name');
$Parameter[1]['description'] = _('A valid kwamoja username. This user should have security access  to this data.');
$Parameter[2]['name'] = _('User password');
$Parameter[2]['description'] = _('The kwamoja password associated with this user name. ');
$ReturnValue[0] = _('If successful this function returns an array of branch codes, which may be strings or integers. ') . _('If the first element is zero then the function was successful.') . '<p>' . _('Otherwise an array of error codes is returned. ');
...
function xmlrpc_GetCustomerBranchCodes($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetCustomerBranchCodes($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetCustomerBranchCodes($xmlrpcmsg->getParam(0)->scalarval(), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
$Description = _('This function is used to retrieve the details of a customer branch from the KwaMoja database.');
$Parameter[0]['name'] = _('Debtor number');
$Parameter[0]['description'] = _('This is a string value. It must be a valid debtor number that is already in the KwaMoja database.');
$Parameter[1]['name'] = _('Branch Code');
$Parameter[1]['description'] = _('This is a string value. It must be a valid branch code that is already in the KwaMoja database, and associated with the debtorno in Parameter[0]');
$Parameter[2]['name'] = _('User name');
$Parameter[2]['description'] = _('A valid kwamoja username. This user should have security access  to this data.');
$Parameter[3]['name'] = _('User password');
$Parameter[3]['description'] = _('The kwamoja password associated with this user name. ');
$ReturnValue[0] = _('If successful this function returns a set of key/value pairs containing the details of this branch. ') . _('The key will be identical with field name from the ') . '<a href="../../Z_DescribeTable.php?table=custbranch">' . _('custbranch table. ') . '</a>' . _('All fields will be in the set regardless of whether the value was set.') . '<p>' . _('Otherwise an array of error codes is returned. ');
...
function xmlrpc_GetCustomerBranch($xmlrpcmsg) {
	ob_start('ob_file_callback');
	/*x*/
	if ($xmlrpcmsg->getNumParams() == 4) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetCustomerBranch($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval(), /*x*/ $xmlrpcmsg->getParam(3)->scalarval())));
		/*x*/
	} else {
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetCustomerBranch($xmlrpcmsg->getParam(0)->scalarval(), /*e*/ $xmlrpcmsg->getParam(1)->scalarval(), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
$Description = _('This function is used to retrieve the details of a customer from the KwaMoja database.');
$Parameter[0]['name'] = _('Debtor number');
$Parameter[0]['description'] = _('This is a string value. It must be a valid debtor number that is already in the KwaMoja database.');
$Parameter[1]['name'] = _('User name');
$Parameter[1]['description'] = _('A valid kwamoja username. This user should have security access  to this data.');
$Parameter[2]['name'] = _('User password');
$Parameter[2]['description'] = _('The kwamoja password associated with this user name. ');
$ReturnValue[0] = _('If successful this function returns a set of key/value pairs containing the details of this customer. ') . _('The key will be identical with field name from the debtorsmaster table. All fields will be in the set regardless of whether the value was set.') . '<p>' . _('Otherwise an array of error codes is returned. ');
...
function xmlrpc_GetCustomer($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetCustomer($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetCustomer($xmlrpcmsg->getParam(0)->scalarval(), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
$Parameter[0]['description'] = _('The name of a database field to search on. ') . _('The field names can be found ') . '<a href="../../Z_DescribeTable.php?table=debtorsmaster">' . _('here ') . '</a>' . _('and are case sensitive. ');
...
$Parameter[3]['name'] = _('User password');
$Parameter[3]['description'] = _('The kwamoja password associated with this user name. ');
$ReturnValue[0] = _('This function returns an array of customer IDs, which may be integers or strings. ') . _('If the first element is zero then the function was successful. ') . _('Otherwise an array of error codes is returned and no insertion takes place. ');
...
function xmlrpc_SearchCustomers($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 4) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(SearchCustomers($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval(), /*x*/ $xmlrpcmsg->getParam(3)->scalarval())));
		/*x*/
	} else {
		$rtn = new xmlrpcresp(php_xmlrpc_encode(SearchCustomers($xmlrpcmsg->getParam(0)->scalarval(), /*e*/ $xmlrpcmsg->getParam(1)->scalarval(), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
$Parameter[0]['description'] = _('A valid kwamoja username. This user should have security access  to this data.');
$Parameter[1]['name'] = _('User password');
$Parameter[1]['description'] = _('The kwamoja password associated with this user name. ');
$ReturnValue[0] = _('This function returns an array of currency abbreviations. ') . _('If the first element is zero then the function was successful. ') . _('Otherwise an array of error codes is returned and no insertion takes place. ');
...
function xmlrpc_GetCurrencyList($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 2) {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetCurrencyList($xmlrpcmsg->getParam(0)->scalarval(), $xmlrpcmsg->getParam(1)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetCurrencyList('', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
function xmlrpc_GetCurrencyDetails($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetCurrencyDetails($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetCurrencyDetails($xmlrpcmsg->getParam(0)->scalarval(), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
$Parameter[1]['name'] = _('User password');
$Parameter[1]['description'] = _('The kwamoja password associated with this user name. ');
$ReturnValue[0] = _('This function returns an array of sales type abbreviations. ') . _('If the first element is zero then the function was successful. ') . _('Otherwise an array of error codes is returned and no insertion takes place. ');
...
function xmlrpc_GetSalesTypeList($xmlrpcmsg) {
	ob_start('ob_file_callback');
	/*x*/
	if ($xmlrpcmsg->getNumParams() == 2) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetSalesTypeList($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetSalesTypeList('', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
function xmlrpc_GetSalesTypeDetails($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetSalesTypeDetails($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetSalesTypeDetails($xmlrpcmsg->getParam(0)->scalarval(), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
$Description = _('This function is used to insert sales type details into the KwaMoja database.');
$Parameter[0]['name'] = _('Sales Type Details');
$Parameter[0]['description'] = _('A set of key/value pairs where the key must be identical to the name of the field to be updated. ') . _('The field names can be found ') . '<a href="../../Z_DescribeTable.php?table=salestypes">' . _('here ') . '</a>' . _('and are case sensitive. ') . _('The values should be of the correct type, and the api will check them before updating the database. ') . _('It is not necessary to include all the fields in this parameter, the database default value will be used if the field is not given.');
$Parameter[1]['name'] = _('User name');
$Parameter[1]['description'] = _('A valid kwamoja username. This user should have security access  to this data.');
$Parameter[2]['name'] = _('User password');
$Parameter[2]['description'] = _('The kwamoja password associated with this user name. ');
...
function xmlrpc_InsertSalesType($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(InsertSalesType(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(InsertSalesType(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
function xmlrpc_GetHoldReasonList($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 2) {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetHoldReasonList($xmlrpcmsg->getParam(0)->scalarval(), $xmlrpcmsg->getParam(1)->scalarval())));
		/*x*/
	} else {
...
function xmlrpc_GetHoldReasonDetails($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetHoldReasonDetails($xmlrpcmsg->getParam(0)->scalarval(), $xmlrpcmsg->getParam(1)->scalarval(), $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetHoldReasonDetails($xmlrpcmsg->getParam(0)->scalarval(), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
function xmlrpc_GetPaymentTermsList($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 2) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetPaymentTermsList($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetPaymentTermsList('', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
function xmlrpc_GetPaymentTermsDetails($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetPaymentTermsDetails($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetPaymentTermsDetails($xmlrpcmsg->getParam(0)->scalarval(), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
function xmlrpc_GetPaymentMethodsList($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 2) {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetPaymentMethodsList($xmlrpcmsg->getParam(0)->scalarval(), $xmlrpcmsg->getParam(1)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetPaymentMethodsList('', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
function xmlrpc_GetPaymentMethodDetails($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetPaymentMethodDetails($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetPaymentMethodDetails($xmlrpcmsg->getParam(0)->scalarval(), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
$Description = _('This function inserts a new stock item into KwaMoja, including updating the locstock table.');
...
function xmlrpc_InsertStockItem($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(InsertStockItem(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(InsertStockItem(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
$Description = _('This function modifies a stock item that already exists in KwaMoja.');
$Parameter[0]['name'] = _('Stock Item Details');
...
function xmlrpc_ModifyStockItem($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(ModifyStockItem(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(ModifyStockItem(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
$Description = _('This function takes a stock item code and returns an array of key/value pairs.') . _('The keys represent the database field names, and the values are the value of that field.');
...
$Parameter[2]['name'] = _('User password');
$Parameter[2]['description'] = _('The kwamoja password associated with this user name. ');
$ReturnValue[0] = _('If successful this function returns a set of key/value pairs containing the details of this stock item. ') . _('The key will be identical with field name from the stockmaster table. All fields will be in the set regardless of whether the value was set.') . '<p>' . _('Otherwise an array of error codes is returned. ');
...
function xmlrpc_GetStockItem($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetStockItem($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetStockItem($xmlrpcmsg->getParam(0)->scalarval(), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
function xmlrpc_SearchStockItems($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 4) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(SearchStockItems($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval(), /*x*/ $xmlrpcmsg->getParam(3)->scalarval())));
		/*x*/
	} else {
		$rtn = new xmlrpcresp(php_xmlrpc_encode(SearchStockItems($xmlrpcmsg->getParam(0)->scalarval(), /*e*/ $xmlrpcmsg->getParam(1)->scalarval(), '', '')));
		/*x*/
	}
	//ob_end_flush();
	return $rtn;
...
function xmlrpc_GetStockBalance($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetStockBalance($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetStockBalance($xmlrpcmsg->getParam(0)->scalarval(), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
function xmlrpc_GetStockReorderLevel($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetStockReorderLevel($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetStockReorderLevel($xmlrpcmsg->getParam(0)->scalarval(), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
$Parameter[3]['description'] = _('A valid kwamoja username. This user should have security access  to this data.');
$Parameter[4]['name'] = _('User password');
$Parameter[4]['description'] = _('The kwamoja password associated with this user name. ');
...
function xmlrpc_SetStockReorderLevel($xmlrpcmsg) {
	ob_start('ob_file_callback');
	/*x*/
	if ($xmlrpcmsg->getNumParams() == 5) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(SetStockReorderLevel($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval(), /*x*/ $xmlrpcmsg->getParam(3)->scalarval(), /*x*/ $xmlrpcmsg->getParam(4)->scalarval())));
		/*x*/
	} else {
		$rtn = new xmlrpcresp(php_xmlrpc_encode(SetStockReorderLevel($xmlrpcmsg->getParam(0)->scalarval(), $xmlrpcmsg->getParam(1)->scalarval(), /*e*/ $xmlrpcmsg->getParam(2)->scalarval(), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
function xmlrpc_GetAllocatedStock($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetAllocatedStock($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetAllocatedStock($xmlrpcmsg->getParam(0)->scalarval(), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
function xmlrpc_GetOrderedStock($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetOrderedStock($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetOrderedStock($xmlrpcmsg->getParam(0)->scalarval(), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
$Parameter[4]['description'] = _('A valid kwamoja username. This user should have security access to this data.');
$Parameter[5]['name'] = _('User password');
$Parameter[5]['description'] = _('The kwamoja password associated with this user name. ');
...
function xmlrpc_SetStockPrice($xmlrpcmsg) {
	ob_start('ob_file_callback');
	/*x*/
	if ($xmlrpcmsg->getNumParams() == 6) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(SetStockPrice($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval(), /*x*/ $xmlrpcmsg->getParam(3)->scalarval(), /*x*/ $xmlrpcmsg->getParam(4)->scalarval(), /*x*/ $xmlrpcmsg->getParam(5)->scalarval())));
		/*x*/
	} else {
		$rtn = new xmlrpcresp(php_xmlrpc_encode(SetStockPrice($xmlrpcmsg->getParam(0)->scalarval(), $xmlrpcmsg->getParam(1)->scalarval(), $xmlrpcmsg->getParam(2)->scalarval(), /*e*/ $xmlrpcmsg->getParam(3)->scalarval(), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
function xmlrpc_GetStockPrice($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 5) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetStockPrice($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval(), /*x*/ $xmlrpcmsg->getParam(3)->scalarval(), /*x*/ $xmlrpcmsg->getParam(4)->scalarval())));
		/*x*/
	} else { //only 3 parameters if login already in session
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetStockPrice($xmlrpcmsg->getParam(0)->scalarval(), $xmlrpcmsg->getParam(1)->scalarval(), /*e*/ $xmlrpcmsg->getParam(2)->scalarval(), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
$Parameter[0]['description'] = _('An associative array describing the customer receipt with the following fields: debtorno - the customer code; trandate - the date of the receipt in Y-m-d format; amountfx - the amount in FX; paymentmethod - the payment method of the receipt e.g. cash/EFTPOS/credit card; bankaccount - the KwaMoja bank account to use for the transaction, reference - the reference to record against the KwaMoja receipt transaction');
$Parameter[1]['name'] = _('User name');
$Parameter[1]['description'] = _('A valid kwamoja username. This user should have security access to this data.');
$Parameter[2]['name'] = _('User password');
$Parameter[2]['description'] = _('The kwamoja password associated with this user name. ');
$ReturnValue[0] = _('This function returns an array of integers. ') . _('If the first element is zero then the function was successful, and the second element is the receipt number. ') . _('Otherwise an array of error codes is returned and no insertion takes place. ');
...
function xmlrpc_InsertDebtorReceipt($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(InsertDebtorReceipt(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), $xmlrpcmsg->getParam(1)->scalarval(), $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(InsertDebtorReceipt(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
function xmlrpc_AllocateTrans($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(AllocateTrans(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), $xmlrpcmsg->getParam(1)->scalarval(), $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(AllocateTrans(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
$Description = _('Creates a credit note from header details associative array and line items. This function implements most of a KwaMoja credit note with the exception that it cannot handle serialised or lot/batch controlled items. All the necessary updates and inserts are handled for stock quantities returned, taxes, sales analysis, stock movements, sales and cost of sales journals');
...
$Parameter[3]['name'] = _('User password');
$Parameter[3]['description'] = _('The kwamoja password associated with this user name. ');
$ReturnValue[0] = _('This function returns an array of integers. ') . _('If the first element is zero then the function was successful, and the second element is the credit note number. ') . _('Otherwise an array of error codes is returned and no insertion takes place. ');
...
function xmlrpc_CreateCreditNote($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 4) {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(CreateCreditNote(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), php_xmlrpc_decode($xmlrpcmsg->getParam(1)), $xmlrpcmsg->getParam(2)->scalarval(), $xmlrpcmsg->getParam(3)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(CreateCreditNote(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), php_xmlrpc_decode($xmlrpcmsg->getParam(1)), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
$Description = _('Inserts a sales invoice into the debtortrans table and does the relevant GL entries. Note that this function does not do the tax entries, insert stock movements, update the stock quanties, sales analysis data or do any cost of sales gl journals. Caution is advised in using this function. To create a full KwaMoja invoice with all tables updated use the InvoiceSalesOrder function.');
$Parameter[0]['name'] = _('Invoice Details');
$Parameter[0]['description'] = _('An array of index/value items describing the invoice.') . _('The field names can be found ') . '<a href="../../Z_DescribeTable.php?table=debtortrans">' . _('here ') . '</a>' . _('and are case sensitive. ') . _('The values should be of the correct type, and the api will check them before updating the database. ') . _('The transno key is generated by this call, and if a value is supplied, it will be ignored. ') . _('Two additional fields are required. "partcode" needs to be a genuine part number, though it appears to serve no real purpose. ') . _('"salesarea" also is required, though again it appears to serve no useful purpose. ') . _('It is not necessary to include all the fields in this parameter, the database default value will be used if the field is not given.');
$Parameter[1]['name'] = _('User name');
$Parameter[1]['description'] = _('A valid kwamoja username. This user should have security access to this data.');
$Parameter[2]['name'] = _('User password');
$Parameter[2]['description'] = _('The kwamoja password associated with this user name. ');
$ReturnValue[0] = _('This function returns an array of integers. ') . _('If the first element is zero then the function was successful, and the second element is the invoice number. ') . _('Otherwise an array of error codes is returned and no insertion takes place. ');
...
function xmlrpc_InsertSalesInvoice($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(InsertSalesInvoice(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(InsertSalesInvoice(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
$Description = _('This function is used to insert a new Sales Credit to the KwaMoja database. Note that this function does not implement a KwaMoja credit note in full and caution is advised in using this function. It does not handle tax at all, it does not add stockmovements, it does not update stock for any quantity returned or update sales analysis. To create a credit note using KwaMoja logic use the CreateCreditNote function');
...
function xmlrpc_InsertSalesCredit($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(InsertSalesCedit(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(InsertSalesCedit(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
$Parameter[0]['description'] = _('A set of key/value pairs where the key must be identical to the name of the field to be updated. ') . _('The field names can be found ') . '<a href="../../Z_DescribeTable.php?table=salesorders">' . _('here ') . '</a>' . _('and are case sensitive. ') . _('The values should be of the correct type, and the api will check them before updating the database. ') . _('The orderno key is generated by this call, and if a value is supplied, it will be ignored. ') . _('It is not necessary to include all the fields in this parameter, the database default value will be used if the field is not given.');
$Parameter[1]['name'] = _('User name');
$Parameter[1]['description'] = _('A valid kwamoja username. This user should have security access  to this data.');
$Parameter[2]['name'] = _('User password');
$Parameter[2]['description'] = _('The kwamoja password associated with this user name. ');
...
function xmlrpc_InsertSalesOrderHeader($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(InsertSalesOrderHeader(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(InsertSalesOrderHeader(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
$Parameter[0]['description'] = _('An integer representing the KwaMoja sales order number');
$Parameter[1]['name'] = _('User name');
$Parameter[1]['description'] = _('A valid kwamoja username. This user should have security access  to this data.');
$Parameter[2]['name'] = _('User password');
$Parameter[2]['description'] = _('The kwamoja password associated with this user name. ');
...
function xmlrpc_InvoiceSalesOrder($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(InvoiceSalesOrder($xmlrpcmsg->getParam(0)->scalarval(), $xmlrpcmsg->getParam(1)->scalarval(), $xmlrpcmsg->getParam(2)->scalarval())));
	} else { //do it with the current login
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(InvoiceSalesOrder($xmlrpcmsg->getParam(0)->scalarval(), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
function xmlrpc_ModifySalesOrderHeader($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(ModifySalesOrderHeader(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(ModifySalesOrderHeader(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
$Parameter[0]['description'] = _('A set of key/value pairs where the key must be identical to the name of the field to be updated. ') . _('The field names can be found ') . '<a href="../../Z_DescribeTable.php?table=salesorderdetails">' . _('here ') . '</a>' . _('and are case sensitive. ') . _('The values should be of the correct type, and the api will check them before updating the database. ') . _('The orderno key must be one of these values. ') . _('It is not necessary to include all the fields in this parameter, the database default value will be used if the field is not given.');
$Parameter[1]['name'] = _('User name');
$Parameter[1]['description'] = _('A valid kwamoja username. This user should have security access  to this data.');
$Parameter[2]['name'] = _('User password');
$Parameter[2]['description'] = _('The kwamoja password associated with this user name. ');
...
function xmlrpc_InsertSalesOrderLine($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(InsertSalesOrderLine(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(InsertSalesOrderLine(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
$Parameter[0]['description'] = _('A set of key/value pairs where the key must be identical to the name of the field to be updated. ') . _('The field names can be found ') . '<a href="../../Z_DescribeTable.php?table=salesorderdetails">' . _('here ') . '</a>' . _('and are case sensitive. ') . _('The values should be of the correct type, and the api will check them before updating the database. ') . _('The orderno and stkcode keys must be one of these values. ') . _('It is not necessary to include all the fields in this parameter, the database default value will be used if the field is not given.');
$Parameter[1]['name'] = _('User name');
$Parameter[1]['description'] = _('A valid kwamoja username. This user should have security access  to this data.');
$Parameter[2]['name'] = _('User password');
$Parameter[2]['description'] = _('The kwamoja password associated with this user name. ');
...
function xmlrpc_ModifySalesOrderLine($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(ModifySalesOrderLine(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(ModifySalesOrderLine(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
function xmlrpc_InsertGLAccount($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(InsertGLAccount(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(InsertGLAccount(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
function xmlrpc_InsertGLAccountSection($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(InsertGLAccountSection(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(InsertGLAccountSection(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
function xmlrpc_InsertGLAccountGroup($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(InsertGLAccountGroup(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(InsertGLAccountGroup(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
function xmlrpc_GetLocationList($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 2) {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetLocationList($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetLocationList('', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
function xmlrpc_GetLocationDetails($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetLocationDetails($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetLocationDetails($xmlrpcmsg->getParam(0)->scalarval(), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
function xmlrpc_GetShipperList($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 2) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetShipperList($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetShipperList('', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
function xmlrpc_GetShipperDetails($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetShipperDetails($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetShipperDetails($xmlrpcmsg->getParam(0)->scalarval(), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
function xmlrpc_GetSalesAreasList($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 2) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetSalesAreasList($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetSalesAreasList('', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
function xmlrpc_GetSalesAreaDetails($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetSalesAreaDetails($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetSalesAreaDetails($xmlrpcmsg->getParam(0)->scalarval(), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
function xmlrpc_GetSalesAreaDetailsFromName($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetSalesAreaDetailsFromName($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetSalesAreaDetailsFromName($xmlrpcmsg->getParam(0)->scalarval(), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
function xmlrpc_InsertSalesArea($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(InsertSalesArea(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(InsertSalesArea(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
function xmlrpc_GetSalesmanList($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 2) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetSalesmanList($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetSalesmanList('', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
function xmlrpc_GetSalesmanDetails($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetSalesmanDetails($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetSalesmanDetails($xmlrpcmsg->getParam(0)->scalarval(), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
function xmlrpc_GetSalesmanDetailsFromName($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetSalesmanDetailsFromName($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetSalesmanDetailsFromName($xmlrpcmsg->getParam(0)->scalarval(), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
function xmlrpc_InsertSalesman($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(InsertSalesman(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(InsertSalesman(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
function xmlrpc_GetTaxGroupList($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 2) {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetTaxGroupList($xmlrpcmsg->getParam(0)->scalarval(), $xmlrpcmsg->getParam(1)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetTaxGroupList('', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
function xmlrpc_GetTaxGroupDetails($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetTaxGroupDetails($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetTaxGroupDetails($xmlrpcmsg->getParam(0)->scalarval(), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
function xmlrpc_GetTaxAuthorityList($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 2) {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetTaxAuthorityList($xmlrpcmsg->getParam(0)->scalarval(), $xmlrpcmsg->getParam(1)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetTaxAuthorityList('', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
function xmlrpc_GetTaxAuthorityDetails($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetTaxAuthorityDetails($xmlrpcmsg->getParam(0)->scalarval(), $xmlrpcmsg->getParam(1)->scalarval(), $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetTaxAuthorityDetails($xmlrpcmsg->getParam(0)->scalarval(), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
function xmlrpc_GetTaxAuthorityRates($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetTaxAuthorityRates($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetTaxAuthorityRates($xmlrpcmsg->getParam(0)->scalarval(), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
function xmlrpc_GetTaxGroupTaxes($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetTaxGroupTaxes($xmlrpcmsg->getParam(0)->scalarval(), $xmlrpcmsg->getParam(1)->scalarval(), $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetTaxGroupTaxes($xmlrpcmsg->getParam(0)->scalarval(), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
function xmlrpc_GetCustomerTypeList($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 2) {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetCustomerTypeList($xmlrpcmsg->getParam(0)->scalarval(), $xmlrpcmsg->getParam(1)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetCustomerTypeList('', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
function xmlrpc_GetCustomerTypeDetails($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetCustomerTypeDetails($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetCustomerTypeDetails($xmlrpcmsg->getParam(0)->scalarval(), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
function xmlrpc_InsertStockCategory($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(InsertStockCategory(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(InsertStockCategory(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
function xmlrpc_ModifyStockCategory($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(ModifyStockCategory(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(ModifyStockCategory(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
$Parameter[1]['name'] = _('User password');
$Parameter[1]['description'] = _('The kwamoja password associated with this user name. ');
$ReturnValue[0] = _('If successful, this function returns an array of stock category ids. ') . _('Otherwise an array of error codes is returned and no stock categories are returned. ');
...
function xmlrpc_GetStockCategoryList($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 2) {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetStockCategoryList($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetStockCategoryList('', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
function xmlrpc_GetStockCategory($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetStockCategory($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetStockCategory($xmlrpcmsg->getParam(0)->scalarval(), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
function xmlrpc_SearchStockCategories($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 4) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(SearchStockCategories($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval(), /*x*/ $xmlrpcmsg->getParam(3)->scalarval())));
		/*x*/
	} else {
		$rtn = new xmlrpcresp(php_xmlrpc_encode(SearchStockCategories($xmlrpcmsg->getParam(0)->scalarval(), /*e*/ $xmlrpcmsg->getParam(1)->scalarval(), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
function xmlrpc_StockCatPropertyList($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 4) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(StockCatPropertyList($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval(), /*x*/ $xmlrpcmsg->getParam(3)->scalarval())));
		/*x*/
	} else {
		$rtn = new xmlrpcresp(php_xmlrpc_encode(StockCatPropertyList($xmlrpcmsg->getParam(0)->scalarval(), /*e*/ $xmlrpcmsg->getParam(1)->scalarval(), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
function xmlrpc_GetGLAccountList($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 2) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetGLAccountList($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetGLAccountList('', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
function xmlrpc_GetGLAccountDetails($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetGLAccountDetails($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetGLAccountDetails($xmlrpcmsg->getParam(0)->scalarval(), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
function xmlrpc_GetStockTaxRate($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 4) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetStockTaxRate($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval(), /*x*/ $xmlrpcmsg->getParam(3)->scalarval())));
		/*x*/
	} else {
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetStockTaxRate($xmlrpcmsg->getParam(0)->scalarval(), /*e*/ $xmlrpcmsg->getParam(1)->scalarval(), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
$Description = _('This function is used to insert a new supplier into the KwaMoja database.');
$Parameter[0]['name'] = _('Supplier Details');
$Parameter[0]['description'] = _('A set of key/value pairs where the key must be identical to the name of the field to be updated. ') . _('The field names can be found ') . '<a href="../../Z_DescribeTable.php?table=suppliers">' . _('here ') . '</a>' . _('and are case sensitive. ') . _('The values should be of the correct type, and the api will check them before updating the database. ') . _('It is not necessary to include all the fields in this parameter, the database default value will be used if the field is not given.');
$Parameter[1]['name'] = _('User name');
$Parameter[1]['description'] = _('A valid kwamoja username. This user should have security access  to this data.');
$Parameter[2]['name'] = _('User password');
$Parameter[2]['description'] = _('The kwamoja password associated with this user name. ');
...
function xmlrpc_InsertSupplier($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(InsertSupplier(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(InsertSupplier(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
$Description = _('This function is used to modify a supplier which is already setup in the KwaMoja database.');
$Parameter[0]['name'] = _('Supplier Details');
$Parameter[0]['description'] = _('A set of key/value pairs where the key must be identical to the name of the field to be updated. ') . _('The field names can be found ') . '<a href="../../Z_DescribeTable.php?table=suppliers">' . _('here ') . '</a>' . _('and are case sensitive. ') . _('The values should be of the correct type, and the api will check them before updating the database. ') . _('It is not necessary to include all the fields in this parameter, the database default value will be used if the field is not given.') . '<p>' . _('The supplierid must already exist in the kwamoja database.');
$Parameter[1]['name'] = _('User name');
$Parameter[1]['description'] = _('A valid kwamoja username. This user should have security access  to this data.');
$Parameter[2]['name'] = _('User password');
$Parameter[2]['description'] = _('The kwamoja password associated with this user name. ');
...
function xmlrpc_ModifySupplier($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(ModifySupplier(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(ModifySupplier(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
$Description = _('This function is used to retrieve the details of a supplier from the KwaMoja database.');
$Parameter[0]['name'] = _('Supplier ID');
$Parameter[0]['description'] = _('This is a string value. It must be a valid supplier id that is already in the KwaMoja database.');
$Parameter[1]['name'] = _('User name');
$Parameter[1]['description'] = _('A valid kwamoja username. This user should have security access  to this data.');
$Parameter[2]['name'] = _('User password');
$Parameter[2]['description'] = _('The kwamoja password associated with this user name. ');
$ReturnValue[0] = _('If successful this function returns a set of key/value pairs containing the details of this supplier. ') . _('The key will be identical with field name from the suppliers table. All fields will be in the set regardless of whether the value was set.') . '<p>' . _('Otherwise an array of error codes is returned. ');
...
function xmlrpc_GetSupplier($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetSupplier($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetSupplier($xmlrpcmsg->getParam(0)->scalarval(), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
$Parameter[3]['name'] = _('User password');
$Parameter[3]['description'] = _('The kwamoja password associated with this user name. ');
$ReturnValue[0] = _('If successful this function returns an array of supplier ids. ') . _('Otherwise an array of error codes is returned. ');
...
function xmlrpc_SearchSuppliers($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 4) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(SearchSuppliers($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval(), /*x*/ $xmlrpcmsg->getParam(3)->scalarval())));
		/*x*/
	} else {
		$rtn = new xmlrpcresp(php_xmlrpc_encode(SearchSuppliers($xmlrpcmsg->getParam(0)->scalarval(), /*e*/ $xmlrpcmsg->getParam(1)->scalarval(), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
$Parameter[3]['name'] = _('User password');
$Parameter[3]['description'] = _('The kwamoja password associated with this user name. ');
$ReturnValue[0] = _('Returns a two dimensional array of stock batch details. ') . _('The fields returned are stockid, loccode, batchno, quantity, itemcost. ');
...
function xmlrpc_GetBatches($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 4) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetBatches($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval(), /*x*/ $xmlrpcmsg->getParam(3)->scalarval())));
		/*x*/
	} else {
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetBatches($xmlrpcmsg->getParam(0)->scalarval(), /*e*/ $xmlrpcmsg->getParam(1)->scalarval(), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
$Parameter[5]['name'] = _('User password');
$Parameter[5]['description'] = _('The kwamoja password associated with this user name. ');
$ReturnValue[0] = _('If successful this function returns 0. ') . _('Otherwise an array of error codes is returned. ');
...
function xmlrpc_StockAdjustment($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 6) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(StockAdjustment($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval(), /*x*/ $xmlrpcmsg->getParam(3)->scalarval(), /*x*/ $xmlrpcmsg->getParam(4)->scalarval(), /*x*/ $xmlrpcmsg->getParam(5)->scalarval())));
		/*x*/
	} else {
		$rtn = new xmlrpcresp(php_xmlrpc_encode(StockAdjustment($xmlrpcmsg->getParam(0)->scalarval(), $xmlrpcmsg->getParam(1)->scalarval(), $xmlrpcmsg->getParam(2)->scalarval(), /*e*/ $xmlrpcmsg->getParam(3)->scalarval(), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
$Parameter[5]['description'] = _('A valid kwamoja username. This user should have security access  to this data.');
$Parameter[6]['name'] = _('User password');
$Parameter[6]['description'] = _('The kwamoja password associated with this user name. ');
$ReturnValue[0] = _('If successful this function returns 0. ') . _('Otherwise an array of error codes is returned. ');
...
function xmlrpc_WorkOrderIssue($xmlrpcmsg) {
	ob_start('ob_file_callback');
	/*x*/
	if ($xmlrpcmsg->getNumParams() == 8) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(WorkOrderIssue($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval(), /*x*/ $xmlrpcmsg->getParam(3)->scalarval(), /*x*/ $xmlrpcmsg->getParam(4)->scalarval(), /*x*/ $xmlrpcmsg->getParam(5)->scalarval(), /*x*/ $xmlrpcmsg->getParam(6)->scalarval(), /*x*/ $xmlrpcmsg->getParam(7)->scalarval())));
		/*x*/
	} else {
		$rtn = new xmlrpcresp(php_xmlrpc_encode(WorkOrderIssue($xmlrpcmsg->getParam(0)->scalarval(), $xmlrpcmsg->getParam(1)->scalarval(), $xmlrpcmsg->getParam(2)->scalarval(), $xmlrpcmsg->getParam(3)->scalarval(), $xmlrpcmsg->getParam(4)->scalarval(), /*e*/ $xmlrpcmsg->getParam(5)->scalarval(), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
$Description = _('This function is used to retrieve the details of a work order from the KwaMoja database.');
$Parameter[0]['name'] = _('Field name');
...
$Parameter[3]['name'] = _('User password');
$Parameter[3]['description'] = _('The kwamoja password associated with this user name. ');
$ReturnValue[0] = _('If successful this function returns an array of work order numbers. ') . _('Otherwise an array of error codes is returned. ');
...
function xmlrpc_SearchWorkOrders($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 4) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(SearchWorkOrders($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval(), /*x*/ $xmlrpcmsg->getParam(3)->scalarval())));
		/*x*/
	} else {
		$rtn = new xmlrpcresp(php_xmlrpc_encode(SearchWorkOrders($xmlrpcmsg->getParam(0)->scalarval(), /*e*/ $xmlrpcmsg->getParam(1)->scalarval(), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
$Description = _('This function is used to insert new purchasing data into the KwaMoja database.');
$Parameter[0]['name'] = _('Purchasing data');
$Parameter[0]['description'] = _('A set of key/value pairs where the key must be identical to the name of the field to be updated. ') . _('The field names can be found ') . '<a href="../../Z_DescribeTable.php?table=purchdata">' . _('here ') . '</a>' . _('and are case sensitive. ') . _('The values should be of the correct type, and the api will check them before updating the database. ') . _('It is not necessary to include all the fields in this parameter, the database default value will be used if the field is not given.');
$Parameter[1]['name'] = _('User name');
$Parameter[1]['description'] = _('A valid kwamoja username. This user should have security access  to this data.');
$Parameter[2]['name'] = _('User password');
$Parameter[2]['description'] = _('The kwamoja password associated with this user name. ');
...
function xmlrpc_InsertPurchData($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(InsertPurchData(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(InsertPurchData(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
$Description = _('This function is used to modify purchasing data into the KwaMoja database.');
$Parameter[0]['name'] = _('Purchasing data');
$Parameter[0]['description'] = _('A set of key/value pairs where the key must be identical to the name of the field to be updated. ') . _('The field names can be found ') . '<a href="../../Z_DescribeTable.php?table=purchdata">' . _('here ') . '</a>' . _('and are case sensitive. ') . _('The values should be of the correct type, and the api will check them before updating the database. ') . _('It is not necessary to include all the fields in this parameter, the database default value will be used if the field is not given.');
$Parameter[1]['name'] = _('User name');
$Parameter[1]['description'] = _('A valid kwamoja username. This user should have security access  to this data.');
...
function xmlrpc_ModifyPurchData($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(ModifyPurchData(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(ModifyPurchData(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
$Description = _('This function is used to insert a new work order into the KwaMoja database. Currently this works only for single line orders.');
$Parameter[0]['name'] = _('Work order details');
$Parameter[0]['description'] = _('A set of key/value pairs where the key must be identical to the name of the field to be updated. ') . _('The field names can be found ') . '<a href="../../Z_DescribeTable.php?table=workorders">' . _('here ') . '</a>' . _('and are case sensitive. ') . _('The values should be of the correct type, and the api will check them before updating the database. ') . _('It is not necessary to include all the fields in this parameter, the database default value will be used if the field is not given.');
$Parameter[1]['name'] = _('User name');
$Parameter[1]['description'] = _('A valid kwamoja username. This user should have security access  to this data.');
$Parameter[2]['name'] = _('User password');
$Parameter[2]['description'] = _('The kwamoja password associated with this user name. ');
...
function xmlrpc_InsertWorkOrder($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 3) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(InsertWorkOrder(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(InsertWorkOrder(php_xmlrpc_decode($xmlrpcmsg->getParam(0)), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
function xmlrpc_WorkOrderReceive($xmlrpcmsg) {
	ob_start('ob_file_callback');
	/*x*/
	if ($xmlrpcmsg->getNumParams() == 7) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(WorkOrderReceive($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval(), /*x*/ $xmlrpcmsg->getParam(3)->scalarval(), /*x*/ $xmlrpcmsg->getParam(4)->scalarval(), /*x*/ $xmlrpcmsg->getParam(5)->scalarval(), /*x*/ $xmlrpcmsg->getParam(6)->scalarval())));
		/*x*/
	} else {
		$rtn = new xmlrpcresp(php_xmlrpc_encode(WorkOrderReceive($xmlrpcmsg->getParam(0)->scalarval(), $xmlrpcmsg->getParam(1)->scalarval(), $xmlrpcmsg->getParam(2)->scalarval(), $xmlrpcmsg->getParam(3)->scalarval(), /*e*/ $xmlrpcmsg->getParam(4)->scalarval(), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
$Description = _('Returns the KwaMoja default date format');
$Parameter[0]['name'] = _('User name');
$Parameter[0]['description'] = _('A valid kwamoja username. This user should have security access  to this data.');
$Parameter[1]['name'] = _('User password');
$Parameter[1]['description'] = _('The kwamoja password associated with this user name. ');
$ReturnValue[0] = _('If successful this function returns a string contain the default date format. ') . _('Otherwise an array of error codes is returned. ');
...
function xmlrpc_GetDefaultDateFormat($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 2) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetDefaultDateFormat($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetDefaultDateFormat('', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
$Description = _('Returns the KwaMoja default shipper');
$Parameter[0]['name'] = _('User name');
$Parameter[0]['description'] = _('A valid kwamoja username. This user should have security access  to this data.');
$Parameter[1]['name'] = _('User password');
$Parameter[1]['description'] = _('The kwamoja password associated with this user name. ');
$ReturnValue[0] = _('If successful this function returns an array of two elements the first should contain an integer of zero for successful and the second an associative array containing the key of confvalue the value of which is the Default_Shipper.') . _('Otherwise an array of error codes is returned. ');
...
function xmlrpc_GetDefaultShipper($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 2) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetDefaultShipper($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetDefaultShipper('', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
$Description = _('Returns the KwaMoja default location');
$Parameter[0]['name'] = _('User name');
$Parameter[0]['description'] = _('A valid kwamoja username. This user should have security access  to this data.');
$Parameter[1]['name'] = _('User password');
$Parameter[1]['description'] = _('The kwamoja password associated with this user name. ');
$ReturnValue[0] = _('If successful this function returns a string contain the default location. ') . _('Otherwise an array of error codes is returned. ');
...
function xmlrpc_GetDefaultCurrency($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 2) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetDefaultCurrency($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval())));
		/*x*/
	} else {
		/*e*/
...
$Description = _('Returns the KwaMoja default price list');
$Parameter[0]['name'] = _('User name');
$Parameter[0]['description'] = _('A valid kwamoja username. This user should have security access  to this data.');
$Parameter[1]['name'] = _('User password');
$Parameter[1]['description'] = _('The kwamoja password associated with this user name. ');
$ReturnValue[0] = _('If successful this function returns a string contain the default price list code. ') . _('Otherwise an array of error codes is returned. ');
...
function xmlrpc_GetDefaultPriceList($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 2) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetDefaultPriceList($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetDefaultPriceList('', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
$Description = _('Returns the KwaMoja default inventory location');
$Parameter[0]['name'] = _('User name');
$Parameter[0]['description'] = _('A valid kwamoja username. This user should have security access  to this data.');
$Parameter[1]['name'] = _('User password');
$Parameter[1]['description'] = _('The kwamoja password associated with this user name. ');
$ReturnValue[0] = _('If successful this function returns a string contain the default inventory location. ') . _('Otherwise an array of error codes is returned. ');
...
$Description = _('Returns the KwaMoja reports directory for the company selected');
$Parameter[0]['name'] = _('User name');
$Parameter[0]['description'] = _('A valid kwamoja username. This user should have security access  to this data.');
$Parameter[1]['name'] = _('User password');
$Parameter[1]['description'] = _('The kwamoja password associated with this user name. ');
...
$Description = _('This function creates a POS data file on the KwaMoja server for download by the POS');
$Parameter[0]['name'] = _('POS Customer Code - a valid KwaMoja customer that sales from the POS are made against.');
$Parameter[0]['description'] = _('POS Customer Branch Code - a valid branch code of the KwaMoja customer that the POS sales are made against');
$Parameter[1]['name'] = _('User name');
$Parameter[1]['description'] = _('A valid kwamoja username. This user should have security access  to this data.');
$Parameter[2]['name'] = _('User name');
$Parameter[2]['description'] = _('A valid kwamoja username. This user should have security access  to this data.');
...
function xmlrpc_CreatePOSDataFull($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 4) {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(CreatePOSDataFull($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), $xmlrpcmsg->getParam(2)->scalarval(), $xmlrpcmsg->getParam(3)->scalarval())));
		/*x*/
	} else {
		/*e*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(CreatePOSDataFull($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
...
$Description = _('This function deletes a POS data file on the KwaMoja server');
$Parameter[0]['name'] = _('User name');
$Parameter[0]['description'] = _('A valid kwamoja username. This user should have security access  to this data.');
$Parameter[1]['name'] = _('User password');
$Parameter[1]['description'] = _('The kwamoja password associated with this user name. ');
...
function xmlrpc_DeletePOSData($xmlrpcmsg) {
	ob_start('ob_file_callback');
	if ($xmlrpcmsg->getNumParams() == 2) {
		$rtn = new xmlrpcresp(php_xmlrpc_encode(DeletePOSData($xmlrpcmsg->getParam(0)->scalarval(), $xmlrpcmsg->getParam(1)->scalarval())));
	} else {
...
$Parameter[3]['name'] = _('User password');
$Parameter[3]['description'] = _('The kwamoja password associated with this user name. ');
$ReturnValue[0] = _('If successful this function returns zero, and the value of the requested property. ') . _('Otherwise an array of error codes is returned. ');
...
function xmlrpc_GetStockCatProperty($xmlrpcmsg) {
	...
	if ($xmlrpcmsg->getNumParams() == 4) /*x*/ {
		/*x*/
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetStockCatProperty($xmlrpcmsg->getParam(0)->scalarval(), /*x*/ $xmlrpcmsg->getParam(1)->scalarval(), /*x*/ $xmlrpcmsg->getParam(2)->scalarval(), /*x*/ $xmlrpcmsg->getParam(3)->scalarval())));
		/*x*/
	} else {
		$rtn = new xmlrpcresp(php_xmlrpc_encode(GetStockCatProperty($xmlrpcmsg->getParam(0)->scalarval(), /*e*/ $xmlrpcmsg->getParam(1)->scalarval(), '', '')));
		/*x*/
	}
	ob_end_flush();
	return $rtn;
