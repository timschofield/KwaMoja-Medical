...
echo '<form onSubmit="return VerifyForm(this)" method="post" class="noPrint" id="RegularPaymentsProcess" action="' . htmlspecialchars($_SERVER['PHP_SELF'], ENT_QUOTES, 'UTF-8') . '">';
