...
if (!isset($_POST['Date'])){
	...
	echo '<div class="centre"><p class="page_title_text noPrint" ><img src="'.$RootPath.'/css/'.$Theme.'/images/transactions.png" title="' . $Title . '" alt="" />' . ' '
	...
	if ($InputError==1){
	 ...
	 echo '<table class="selection">
	        <tr>
				...
				<td><input type="text" name="Date" minlength="0" maxlength="10" size="10" class="date" alt="' . $_SESSION['DefaultDateFormat'] . '" value="' . Date($_SESSION['DefaultDateFormat']) . '" /></td>
			</tr>';
